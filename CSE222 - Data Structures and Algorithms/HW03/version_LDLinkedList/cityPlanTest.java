...
public class cityPlanTest
{
    ...
    public static void main(String[] args)
    {
        ...
        streetLD mainStreet = new streetLD(50);
        ...
        System.out.println("________________TESTING displayListView() METHOD________________\n");
        System.out.println("In this section displayListView() method displays\n" +
                "the elements of lists.");
        mainStreet.displayListView();
        System.out.println("\n");
