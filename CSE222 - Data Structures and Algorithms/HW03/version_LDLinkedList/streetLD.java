 ...
 * that will be used for designing a small one street town (with using LDLinkedList structure).
 * @author Ali KAYA
 * @version 1.0
 * @since 2022-03-20
 */
public class streetLD {
    ...
    public streetLD(int newLength) {
        ...
        listBack = new LDLinkedList<>();
        listFront = new LDLinkedList<>();
    }
    ...
    {
        System.out.println("view of back list :\n" + listBack.toString());
        System.out.println("view of front list :\n" + listFront.toString());
    }
    ...
    public static void menu()
    {
        ...
        System.out.print("\nWELCOME to THE STREET PLANNER PROGRAM\n");
        ...
        streetLD myStreet = new streetLD(modeSelect);
